...
//            });
            ...
            var touristRouteJsonData =
                File.ReadAllText(Path.GetDirectoryName(Assembly.Load("Wk.Study.Model").Location).Replace("/bin/Debug/netcoreapp3.1","")+
    ...
    public class BloggingContextFactory : IDesignTimeDbContextFactory<AppDbContext>
    {
        public AppDbContext CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseSqlServer("server=localhost; Database=FakeXiechengDb; User Id=sa; Password=wk19940419!;");
